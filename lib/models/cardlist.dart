...
List<description> disciption_list = [
  ...
  description('Extraverted, Intuitive, Feeling, and Prospecting'),
  description('Extraverted, Intuitive, Thinking, and Judging'),
  description('Extraverted, Intuitive, Thinking, and Prospecting'),
  description('Extraverted, Observant, Feeling, and Judging'),
  description('Extraverted, Observant, Feeling, and Judging'),
  description('Extraverted, Observant, Thinking, and Judging'),
  description('Extraverted, Observant, Thinking, and Prospecting'),
  description('Introverted, Intuitive, Feeling, and Judging'),
  description('Introverted, Intuitive, Feeling, and Prospecting'),
  description('Introverted, Intuitive, Thinking, and Judging'),
  description('Introverted, Intuitive, Thinking, and Prospecting'),
  description('Introverted, Observant, Feeling, and Judging'),
  description('Introverted, Observant, Feeling, and Prospecting'),
  description('Introverted, Observant, Thinking, and Judging'),
  description('Introverted, Observant, Thinking, and Prospecting'),
];
